                ...
                child: Column(
                  children: [
                          ...
                          RichText(
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(text: viewModel.address ?? "",
                      ...
                      child: Container(
                          ...
                          child: const Text(
                            'Chọn hình ảnh thực tế cho phòng trọ'
                                '\n(Ít nhất một ảnh và tối đa 10 ảnh)',
                    ...
                    CustomDefaultButton(
                      ...
                      title: "Đăng bài",
                      onTap: (){
                        // viewModel.addMultiImages();
                        viewModel.addImage();
                        if(viewModel.listImagesLink.isNotEmpty){
                          print(viewModel.listImagesLink[0].url);
                        } else{
                          print("image null");
                        }
                        if(globalKey.currentState!.validate()){
                          context.showMessage("Hahahahhaha");
                        } else {
                          if(viewModel.cityName == null){
                          ...
                          if(viewModel.addPostModel.info?.categoryId == null){
                            setState(() => _isValidCategories = true);
                          }
                          if(viewModel.addPostModel.info?.objectId == null){
